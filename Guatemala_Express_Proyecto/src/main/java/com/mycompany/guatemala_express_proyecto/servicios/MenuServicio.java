...
public class MenuServicio {
    ...
    private void agregarItemsGenerales(List<MenuItem> menu) {
        ...
        MenuItem cartera = new MenuItem("Cartera", "/cartera/recargar");
    ...
    private void agregarMenuAdministradorSistema(List<MenuItem> menu) {
        ...
        MenuItem configuraciones = new MenuItem("Configurar monto de depreciación", "/configuraciones/depreciacion");
    ...
    private void agregarMenuAdministradorSucursal(List<MenuItem> menu) {
        ...
        chofer.agregarSubOpcion("Activar/Desactivar chofer", "/administrador_sucursal/activar_desactivar_chofer");
        menu.add(chofer);
        ...
        reportes.agregarSubOpcion("Depreciación por bus", "/administrador_sucursal/reportes/depreciacion_por_bus");
        menu.add(reportes);
