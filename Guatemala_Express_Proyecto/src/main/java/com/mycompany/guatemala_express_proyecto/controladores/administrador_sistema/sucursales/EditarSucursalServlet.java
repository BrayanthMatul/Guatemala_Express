...
public class EditarSucursalServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id <= 0) {
            ...
            session.setAttribute("mensajeModal", "No se indicó la sucursal que se desea editar.");
        ...
        if (session.getAttribute("edicion") != null) {
            ...
            try {
                ...
                if (sucursalOptional.isPresent()) {
                    ...
                    session.setAttribute("tituloModal", "Error");
                    session.setAttribute("mensajeModal", "No se encontró la sucursal.");
                    response.sendRedirect(request.getContextPath() + "/administrador_sistema/lista_sucursales");
                    return;
                }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(
                    request.getContextPath() + "/administrador_sistema/editar_sucursal?id=" + sucursal.getId());
        }
    ...
    private void colocarDatosSucursalEnRequest(HttpServletRequest request, Sucursal sucursal) {
