<%-- 
    Document   : registrar-sucursal
    Created on : Sep 10, 2026, 3:58:37 AM
    Author     : matul
--%>
    ...
    <body>
        ...
        <main class="contenedor">
            ...
            <section class="tarjeta">
                ...
                <form method="POST" action="${pageContext.request.contextPath}/administrador_sistema/registrar_sucursal">
                    <input
                        id="longitud"
                        type="hidden"
                        name="longitud"
                    ...
                    <div class="formulario-y">
                        ...
                        <div>
                            ...
                            <div id="mapaSucursal" class="w-full rounded-lg h-96"></div>
                        </div>
